...
from U_NET_RES.unet_res_model import UNetResidual
...
if __name__ == '__main__':
    ...
    model = UNetResidual(n_channels=3, n_classes=NUM_CLASSES).to(DEVICE)
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            best_model_path = 'unet_res_forest_best.pth'
